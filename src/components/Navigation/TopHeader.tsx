...
const TopHeader: React.FC = () => {
  ...
  return (
    <div className="lg:block pr-bg relative z-100 w-full">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-10 py-1">
        <div className="flex flex-wrap items-center justify-between gap-2 py-2 text-xs font-medium text-gray-700 font-sans">
          {/* Left side */}
          <div className=" hidden md:flex flex-wrap items-center gap-1 sm:gap-2 text-center sm:text-left justify-center sm:justify-start w-full sm:w-auto">
            <svg
              stroke="currentColor"
              fill="none"
              strokeWidth="2"

...
export function transformProductToCollectionCartItem(productCollection: ProductCollection): FrontEndProductCartItem {
  ...
  return {
    ...
    url_key: product.sku.toLowerCase().replace(/\s+/g, "-"), // Basic slug from SKU
    price: product.price,
